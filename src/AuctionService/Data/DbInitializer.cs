...
public class DbInitializer
{
  ...
  {
    // we need to create scope to acceess service before dependency injection is setup during app.run
  ...
  {
    Console.WriteLine("Seed db with some preconfigured items.");
    context.Database.Migrate();

    if (context.Auctions.Any())
    {
      Console.WriteLine("Already have data, no seed required");
      return;
    }
